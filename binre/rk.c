...
static unsigned short rkxb[256*256];
...
void io_rk_write(u32 addr, u16 data, int writeb)
{
    printf("io_rk_write %o decode %o, data %o\n",
           addr, ((addr >> 1) & 07), data);
